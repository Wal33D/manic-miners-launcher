 ...
 */
export const renameFile = async ({ filePath, desiredFileName, desiredFileExt }: { filePath: string; desiredFileName?: string; desiredFileExt?: string }): Promise<{ status: boolean; message: string; newFilePath?: string }> => {
   let message = '';
