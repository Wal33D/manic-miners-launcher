...
import { setupInstallLatestVersionHandler } from './ipcHandlers/setupInstallLatestVersionHandler';
import { setupCheckLatestInstalledHandler } from './ipcHandlers/setupCheckLatestInstalledHandler';
...
const startApp = (): void => {
  app.on('ready', async () => {
    ...
    setupInstallLatestVersionHandler();
    setupCheckLatestInstalledHandler();
