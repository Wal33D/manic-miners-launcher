    ...
    <div className="container mx-auto p-6 space-y-6">
      <Card className="mining-surface energy-glow">
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">Create custom mining levels with procedural generation</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <Slider value={size} onValueChange={setSize} min={16} max={64} step={8} className="w-full" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Slider value={crystalDensity} onValueChange={setCrystalDensity} min={0} max={100} step={5} className="w-full" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Slider value={enemies} onValueChange={setEnemies} min={0} max={100} step={5} className="w-full" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Slider value={terrain} onValueChange={setTerrain} min={0} max={100} step={5} className="w-full" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <Button variant="energy" className="flex-1" onClick={handleGenerate} disabled={generating || !mapName}>
              {generating ? (
                'Generating...'
              ) : (
                <>
      ...
      <Card className="mining-surface">
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">Generated map details and download options</CardDescription>
        </CardHeader>
        <CardContent>
          {generating ? (
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-secondary-foreground">{mapName || 'Untitled Map'}</h3>
