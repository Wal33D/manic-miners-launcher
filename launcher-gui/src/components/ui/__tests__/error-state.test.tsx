...
describe('ErrorState', () => {
  ...
  it('renders custom title and message', () => {
    render(<ErrorState title="Network Error" message="Unable to connect to server" />, { wrapper: BrowserRouter });
  ...
  it('shows retry button when onRetry is provided', () => {
    const onRetry = vi.fn();
    render(<ErrorState onRetry={onRetry} />, { wrapper: BrowserRouter });
  ...
  it('hides retry button when showRetry is false', () => {
    const onRetry = vi.fn();
    render(<ErrorState onRetry={onRetry} showRetry={false} />, { wrapper: BrowserRouter });

    expect(screen.queryByRole('button', { name: /try again/i })).not.toBeInTheDocument();
  });

  it('shows home button when showHome is true', () => {
    render(<ErrorState showHome={true} />, { wrapper: BrowserRouter });
  ...
  it('applies correct variant styling', () => {
    const { container } = render(<ErrorState variant="warning" />, { wrapper: BrowserRouter });
  ...
  it('applies custom className', () => {
    const { container } = render(<ErrorState className="custom-error-class" />, { wrapper: BrowserRouter });
