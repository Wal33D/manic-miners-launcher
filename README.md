...
The launcher does not bundle these tools, so make sure Wine, Proton, or your preferred compatibility layer is installed and available on your system's `PATH`.
